...
export function BenchmarkHero() {
  return (
    <section className="relative bg-[#9cb8c8] grid-bg border-b-2 border-[#7a9ab0] snap-start h-screen flex items-center">
          ...
          <div className="max-w-2xl">
            ...
            <Reveal delayMs={120}>
              <p className="text-lg text-[#2a2a2a] max-w-xl font-medium">
                wcw 与 Greptile、Cursor、Copilot、CodeRabbit、Graphite 五款主流 AI 代码审查工具的全面对比评测。 基于
                50 个来自真实生产环境的 bug，看看谁才是真正的代码守护者。
              </p>
            </Reveal>
          </div>
          <Reveal delayMs={220}>
